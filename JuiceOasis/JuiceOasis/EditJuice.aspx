<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeBehind="EditJuice.aspx.cs" Inherits="JuiceOasis.EditJuice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-container">
        ...
        <!-- Save Button -->
        <asp:Button ID="btnSaveJuice" runat="server" Text="Save" CssClass="submit-button" OnClick="btnSaveJuice_Click" />
    </div>
</asp:Content>
